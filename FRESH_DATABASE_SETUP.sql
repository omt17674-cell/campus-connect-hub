-- ============================================================================
-- GSFC Campus Connect Hub - Fresh Database Setup (24 Tables)
-- This script creates a clean database with all 24 tables
-- ============================================================================

-- DROP EXISTING POLICIES FIRST (to avoid conflicts)
DROP POLICY IF EXISTS "Public can read events" ON public.events;
DROP POLICY IF EXISTS "Public can read registrations" ON public.registrations;
DROP POLICY IF EXISTS "Authenticated can register" ON public.event_registrations;
DROP POLICY IF EXISTS "Public can read internships" ON public.internships;
DROP POLICY IF EXISTS "Public can read announcements" ON public.campus_announcements;
DROP POLICY IF EXISTS "Public can read services" ON public.campus_services;
...
DROP POLICY IF EXISTS "Public can read attendance" ON public.attendance_records;
...
CREATE INDEX idx_user_profiles_roll_no ON public.user_profiles(roll_no);
...
-- ============================================================================
-- SUCCESS! All 24 tables created and configured
-- ============================================================================
